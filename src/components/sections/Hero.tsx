...
export function Hero() {
  return (
    ...
    >
      ...
      {/* 背景写真を透過表示 */}
      <img
        src="https://images.unsplash.com/photo-1614083557249-5ddaeaddbe48?q=80&w=580&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        alt=""
        aria-hidden
        loading="lazy"
